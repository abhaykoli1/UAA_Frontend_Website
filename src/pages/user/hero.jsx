  ...
  return (
    <div className="mt- text-white">
      <div className="relative">
        <img src={hero} alt="home image" className="bg-center mx-auto" />
        <div className="lg:container mx-auto">
          {/* <motion.button
            className=" bg-indigo-600 max-w-96 uppercase  mt-10   mr-4 sm:mr-5 hover:bg-indigo-700 text-white font-semibold transition duration-500 lg:py-3 md:py-2 py-1 lg:px-4 md:px-4 px-3  rounded mb-4 sm:mb-0"
