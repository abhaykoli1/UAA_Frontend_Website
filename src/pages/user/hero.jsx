  ...
  return (
    <div className=" py- text-white">
      <div className="relative">
        ...
        <motion.button
          className="bg-indigo-600 mx-10 mt-10   mr-4 sm:mr-5 hover:bg-indigo-700 text-white font-semibold transition duration-500 py-2 px-4 sm:px-6 rounded mb-4 sm:mb-0"
